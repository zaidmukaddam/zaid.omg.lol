...
This is what the `contentlayer.config.ts` looks like. You can check the complete code [here](https://github.com/zaidmukaddam/zaid.omg.lol/blob/main/contentlayer.config.ts).
...
I hope you liked this article. Please let me know if you have any questions or suggestions via [Twitter](https://twitter.com/zaidmukaddam).
