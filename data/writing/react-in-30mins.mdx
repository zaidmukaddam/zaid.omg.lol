...
date: '2022-11-27'
status: published
keywords: 'technical, react, developer,'
summary: React is, as their website says, "a JavaScript library for building user interfaces." What this means exactly, is often confusing to people.
...
_Turning HTML into the DOM and then into the actual site_

<img
  src="https://cdn.hashnode.com/res/hashnode/image/upload/v1669183083108/fAB5OHPKC.png"
  alt="Turning HTML into the DOM and then into the actual site"
  width="auto"
  height="auto"
/>
...
_React's Virtual DOM in action. ReactDOM.render() tells React to attach your React components to the real DOM_

<img
  src="https://cdn.hashnode.com/res/hashnode/image/upload/v1669184277065/ryOD5ej3V.png"
  alt="React's Virtual DOM in action. ReactDOM.render() tells React to attach your React components to the real DOM"
  width="auto"
  height="auto"
/>
### Components Another things that React tackles really well is that regular
HTML and JS makes it a lot more difficult than it should be to re-use the
same UI and logic across different pages on your website.

_What if you wanted to reuse this 'product card' component?_

<img
  src="https://cdn.hashnode.com/res/hashnode/image/upload/v1669184324271/nYR1rrU5j.png"
  alt="What if you wanted to reuse this 'product card' component?"
  width="auto"
  height="auto"
/>

The main philosophy of functional React is that you shouldn't override and inherit behaviour. Instead, get the behaviour you want by creating and composing reusable _components_. Each of these components can hold some sort of data of its own, called its **state**. Each component can also take in a few arguments or parameters called **properties** or **props** for short. Each component is composed up of either primative HTML elements (e.g. `<div>` or `<h1>`) or other React components. The elements that a component is made up of are called its **children**.

_React Component Diagram_

<img
  src="https://cdn.hashnode.com/res/hashnode/image/upload/v1669184327760/mGHsPz6za.png"
...
_React Component Lifecycle_

<img
  src="https://cdn.hashnode.com/res/hashnode/image/upload/v1669184314028/K_9GBlMU3.png"
...
To get started open your terminal of choice and clone this [minimal React template](https://github.com/zaidmukaddam/minireact). This will give you all the code you need to get started!

```bash
// clone the repository
$ git clone https://github.com/zaidmukaddam/minireact.git
...
_Our todo app with a strikethrough effect!_

<img
  src="https://cdn.hashnode.com/res/hashnode/image/upload/v1669184291716/6yeNZ3l36.png"
  alt="Our todo app with a strikethrough effect!"
  width="auto"
  height="auto"
/>
...
_A nice new 'Add Todo' field!_

<img
  src="https://cdn.hashnode.com/res/hashnode/image/upload/v1669184303636/xx1yHF7ua.png"
  alt="A nice new 'Add Todo' field!"
  width="auto"
  height="auto"
/>
...
_Our working todo tracker!_

<img
  src="https://cdn.hashnode.com/res/hashnode/image/upload/v1669184308880/OExUrPFFz.gif"
  alt="Our working todo tracker!"
  width="auto"
  height="auto"
/>
